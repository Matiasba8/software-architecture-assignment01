defmodule Assignment01Web.AuthorControllerTest do
  use Assignment01Web.ConnCase

  import Assignment01.AuthorContextFixtures

  @create_attrs %{name: "some name", date_of_birth: ~D[2023-08-04], country_of_origin: "some country_of_origin", short_description: "some short_description"}
